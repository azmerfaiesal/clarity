...
//
// With no env vars at all, it still points at the real project — you just need to
// set VITE_SUPABASE_ANON_KEY (and ideally URL) for production builds via the
// GitHub Actions secret, or a local .env file for `npm run dev`.
