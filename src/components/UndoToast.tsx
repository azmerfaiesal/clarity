  ...
  return (
    ...
    >
      ...
      <button
        type="button"
        onClick={onUndo}
        className="inline-flex shrink-0 cursor-pointer items-center gap-1.5 rounded-md px-2.5 py-1.5 text-sm font-medium text-accent transition-colors hover:bg-accent-soft"
      >
